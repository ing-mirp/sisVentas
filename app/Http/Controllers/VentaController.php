...
use Carbon\Carbon;//Para usar la fecha y hora de nuestra zona horaria
use Response;
...
class VentaController extends Controller
{
    ...
    {
        try {//Utilizamos una transacción porque los datos van a ir a 2 tablas y si una falla, no debe registrarse en ninguna
        	...
        	DB::commit();//Finaliza transacción
        } catch (Exception $e) {
        	DB::rollback();//Anula transacción
        }
